...
class EtudiantResourceIT {
    ...
    void createEtudiant() throws Exception {
        ...
        assertThat(testEtudiant.getNumeroEtudiant()).isEqualTo(DEFAULT_NUMERO_ETUDIANT);
    ...
    void putNewEtudiant() throws Exception {
        ...
        Etudiant testEtudiant = etudiantList.get(etudiantList.size() - 1);
        assertThat(testEtudiant.getNumeroEtudiant()).isEqualTo(UPDATED_NUMERO_ETUDIANT);
    ...
    void partialUpdateEtudiantWithPatch() throws Exception {
        ...
        partialUpdatedEtudiant.numeroEtudiant(UPDATED_NUMERO_ETUDIANT).prenom(UPDATED_PRENOM);
